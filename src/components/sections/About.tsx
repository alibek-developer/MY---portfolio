				...
				return (
					...
					>
						...
						<div style={{ paddingBottom: last ? 0 : 22 }}>
							...
							<div style={{ fontSize: 11, marginTop: 3, color: c.textMuted }}>
								{x.place} · {x.period}
							</div>
						</div>
					</motion.div>
		...
		>
			...
			<div
				style={{
					...
					inset: 0,
					background:
						'linear-gradient(to top, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.18) 50%, transparent 100%)',
					pointerEvents: 'none',
				}}
			/>
			{/* Badges */}
	...
	return (
		...
		>
			...
			>
				...
				>
					...
					>
						<div>
							...
							<motion.p
								{...fadeRight(0.34)}
								style={{ fontSize: 15, lineHeight: 1.8, color: c.textSec }}
							>
								Deeply into{' '}
						...
						<motion.div {...fadeUp(0.4)} style={{ marginTop: 36 }}>
							<div
								style={{ height: 1, background: c.divider, marginBottom: 22 }}
							/>
							<div
								style={{
									fontSize: 10,
				...
				>
					{/* Experience */}
					<Card c={c} delay={0.2} style={{ padding: '36px 40px' }}>
						<motion.div {...fadeUp(0.24)}>
							<div style={{ marginBottom: 26 }}>
								<SectionLabel icon={Ico.Work} text='Experience' c={c} />
							</div>
					...
					<Card c={c} delay={0.24} style={{ padding: '36px 40px' }}>
						<motion.div {...fadeUp(0.28)}>
							<div style={{ marginBottom: 26 }}>
								<SectionLabel icon={Ico.Heart} text='Interests' c={c} />
							</div>
